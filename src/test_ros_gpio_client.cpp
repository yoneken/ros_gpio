...
int main(int argc, char **argv)
{
  ...
  ros::ServiceClient clientOpen = n.serviceClient<ros_gpio::OpenGpio>("gpio_server");
  ...
  ros::ServiceClient clientSetDir = n.serviceClient<ros_gpio::SetGpioDir>("gpio_server");
  ...
  ros::ServiceClient clientWrite = n.serviceClient<ros_gpio::WriteGpio>("gpio_server");
  ...
  ros::ServiceClient clientClose = n.serviceClient<ros_gpio::CloseGpio>("gpio_server");
